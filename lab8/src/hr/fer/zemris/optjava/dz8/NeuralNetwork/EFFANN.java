...
/**
 * Elman-feedforward-artificial-neural-network implementation.
 */
public class EFFANN implements INeuralNetwork{
    private int[] nnTopology;
    private ITransferFunction[] layerTransferFunctions;
    private int numberOfWeights;
    private ITransferFunction outputFunction;

    private RealVector contextVector;

    public EFFANN(int[] nnTopology, ITransferFunction[] layerTransferFunctions, ITransferFunction outputFunction) {
        this.nnTopology = nnTopology;
        this.layerTransferFunctions = layerTransferFunctions;
        this.outputFunction = outputFunction;

        // initialize the context vector
        this.contextVector = new ArrayRealVector(nnTopology[1]);
    ...
    private void calculateNumberOfWeights() {
        ...
        int previous = nnTopology[0] + contextVector.getDimension();
        int number = 0;
    ...
    public RealVector calcOutputs(RealVector input, RealVector weights, boolean training) {
        ...
        input = input.append(contextVector);
    ...
    private List<RealMatrix> convertVectorToMatrixList(RealVector weights) {
        ...
        int prevVectorDim = nnTopology[0] + contextVector.getDimension();
