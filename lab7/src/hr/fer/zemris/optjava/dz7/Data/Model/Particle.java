package hr.fer.zemris.optjava.dz7.Data.Model;

import hr.fer.zemris.optjava.dz7.Algorithm.PSOAlgorithm;
import hr.fer.zemris.optjava.dz7.Data.Data;
...
public class Particle extends Solution {
    ...
    private RealVector createVectorVelocity(
        ...
        while(finVector.getL1Norm() > PSOAlgorithm.VMAX ){
            finVector = finVector.mapMultiply(0.9);
        }

        while(finVector.getL1Norm() < PSOAlgorithm.VMIN){
            finVector = finVector.mapMultiply(1.1);
        }
